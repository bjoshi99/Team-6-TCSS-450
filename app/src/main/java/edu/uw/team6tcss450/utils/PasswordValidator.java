package edu.uw.team6tcss450.utils;
...
public interface PasswordValidator
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdLength() {
     ...
     * @return a validator that validates the length of the String as > 6
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdLength(int length) {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdDigit() {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdUpperCase() {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdLowerCase() {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdSpecialChar() {
     ...
     * @return a validator that validates that the String contains a special character
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdSpecialChar(String specialChars) {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkPwdDoNotInclude(String excludeChars) {
        return password ->
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkExcludeWhiteSpace() {
        return password ->
                Optional.of(!checkStringContains(password, //NOTE the !
     ...
     */
    static edu.uw.team6tcss450.utils.PasswordValidator checkClientPredicate(Predicate<String> theTest) {
        return password ->
     ...
     */
    default edu.uw.team6tcss450.utils.PasswordValidator and(edu.uw.team6tcss450.utils.PasswordValidator other) {
...
//                .or(() -> other.apply(password));
     ...
     *      this PasswordValidator and another
     */
    default edu.uw.team6tcss450.utils.PasswordValidator or(edu.uw.team6tcss450.utils.PasswordValidator other) {
        return password -> this.apply(password)
                .flatMap(result -> result == ValidationResult.SUCCESS ?
